...
-- ============================================================================
-- 
-- IMPORTANTE: Este script é executado automaticamente quando o backend inicia.
-- Não é necessário executar manualmente no DBeaver ou pgAdmin!
-- 
